 ...
 * @str:nstring whose length is to be found
 ...
 * @s1: first string
 * @s2: second string
 * Return: conts of s1, followed by the contents of s2, and null terminated.
 * if NULL is pssed, treat it as an empty sring
